...
**📋 NOTE FOR OPENCODE ASSISTANT:**
When Bala reads this file, he will need help executing the testing scenarios.
- He is not familiar with API testing or curl commands
- He created 9 PURCHASE transactions by mistake (should have been AUTH)
- He needs hand-holding for each step
- Help him run the curl commands from the staging server
- Help him fill the UAT document with correct transaction IDs
- Guide him through each scenario one by one
- Be patient - he needs detailed instructions
