...
const expectedColumns = {
  ...
  services: ['id', 'title', 'category', 'subcategory', 'price', 'duration', 'image', 'description', 'popular', 'enquiry_only', 'attributes', 'vendor_prices', 'created_at', 'updated_at'],
  bookings: ['id', 'customer_name', 'customer_email', 'customer_phone', 'service_title', 'vendor_name', 'vendor_id', 'service_id', 'price', 'date', 'time_slot', 'region', 'status', 'notes', 'created_at', 'updated_at'],
