...
class HomeHealthcareServicesSeeder extends Seeder
{
    use FormatsTitles;
    ...
    private const CATEGORY_MAP = [
        ...
        'Long Term Specialised care' => 'home-healthcare',
        'Doctor on Call' => 'home-healthcare',
        'Physiotherapy at home' => 'home-healthcare',
        'Speech and Language Therapy' => 'home-healthcare',
        'Occupational Therapy' => 'home-healthcare',
    ];

    private function resolveImage(string $category, string $subcat, string $slug): string
    {
        return "/images/{$category}/{$subcat}/{$slug}.jpg";
    }
    ...
    public function run(): void
    {
        ...
        foreach ($services as $index => $data) {
            ...
            $service->fill([
                ...
                'image' => $this->resolveImage(self::CATEGORY_MAP[$data['sub']], $subcatSlug, $slug),
