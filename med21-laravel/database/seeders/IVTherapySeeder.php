...
class IVTherapySeeder extends Seeder
{
    ...
    private function resolveIVImage(string $name): string
    {
        return match (true) {
            ...
            str_contains($name, 'NAD 500') => '/images/services/nad-anti-aging-iv-therapy.jpg',
            str_contains($name, 'NAD 250') => '/images/services/nad-anti-aging-iv-therapy.jpg',
            str_contains($name, 'NAD 100') => '/images/services/nad-anti-aging-iv-therapy.jpg',
            str_contains($name, 'Hair') => '/images/services/hair-loss-iv-therapy.jpg',
            str_contains($name, 'Energy') || str_contains($name, 'Weight') => '/images/services/energy-and-weight-loss-iv-therapy.jpg',
            str_contains($name, 'Immune') || str_contains($name, 'Hydration') => '/images/services/immune-hydration-drip.jpg',
            str_contains($name, 'Antistress') || str_contains($name, 'Relax') => '/images/services/antistress-and-antioxidant-iv-therapy.jpg',
            str_contains($name, 'Gut') || str_contains($name, 'Acne') => '/images/services/gut-cleanse-and-acne-cure-iv-therapy.jpg',
            ...
            str_contains($name, 'Women') || str_contains($name, 'Fertility') => '/images/services/womens-health-fertility-iv-therapy.jpg',
            str_contains($name, 'Men') => '/images/services/mens-power-iv-drip.jpg',
