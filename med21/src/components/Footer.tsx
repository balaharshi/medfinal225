      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 text-left">
          ...
          <div className="space-y-3.5">
            ...
            <ul className="space-y-2 text-xs text-gray-300">
              <li><button onClick={() => handleFooterNavigation('providers')} className="hover:text-white hover:underline transition-colors cursor-pointer">Clinician Network</button></li>
