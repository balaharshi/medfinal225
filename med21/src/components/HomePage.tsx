...
export default function HomePage({
  ...
  return (
    ...
    >
      {/* Hero Banner */}
      <section className="relative w-full pb-2 sm:pb-0">
        <SafeImage
          src="/b23.png"
          alt="Complete Healthcare Anytime Anywhere"
          className="w-full h-auto object-cover"
        />
        <div className="sm:absolute sm:bottom-[8%] md:bottom-[10%] lg:bottom-[12%] sm:left-[4%] flex gap-2 sm:gap-3 md:gap-4 mt-4 sm:mt-0 px-4 sm:px-0">
          <button
