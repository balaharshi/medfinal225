...
const withRentalEquipmentImages = (products: Product[]) =>
  products.map((product) => {
    ...
    return { ...product, image: `/images/products/${imageName}.jpg` };
  });
...
const BASE_SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    ...
    image: '/images/services/generic-nurse.jpg',
  ...
  },
  {
    ...
    image: '/images/services/physiotherapy-session.jpg',
    slug: 'physiotherapy',
  ...
  },
  {
    ...
    image: '/images/services/doctor-portrait.jpg',
    slug: 'doctor-on-call',
  ...
  },
  {
    id: 'cat-iv-therapy',
    title: 'IV Therapy',
    image: '/images/services/iv-drip-bag.jpg',
    slug: 'iv-therapy',
  ...
  },
  {
    ...
    image: '/images/services/lab-technicians.jpg',
  ...
  },
  {
    ...
    image: '/images/services/doctor-phone.jpg',
  ...
  },
  {
    ...
    image: '/images/services/fitness-exercise.jpg',
  ...
  },
  {
    ...
    image: '/images/services/lab-research.jpg',
  ...
  },
  {
    ...
    image: '/images/services/shipping-crew.jpg',
...
const BASE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 120,
    originalPrice: 336,
    image: '/images/services/emergency-medical.jpg',
    category: 'devices-for-rent',
    subcategory: 'rent-medical-equipments',
    brand: 'Rental Equipment',
    rating: 4.8,
...
export const HEALTHCARE_SERVICES: HealthcareService[] = withHomeHealthcareImages(
  mergeById(
    mergeById(mergeById(mergeById(BASE_HEALTHCARE_SERVICES_WITHOUT_LEGACY_HOME, CUSTOMIZE_LAB_SERVICES), LAB_TESTS_AT_HOME_SERVICES),
